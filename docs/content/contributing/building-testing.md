...
[...]
 => => naming to docker.io/library/traefik-dev:v2.6
docker run -v "/var/run/docker.sock:/var/run/docker.sock"   -e OS_ARCH_ARG -e OS_PLATFORM_ARG -e TESTFLAGS -e VERBOSE -e VERSION -e CODENAME -e TESTDIRS -e CI -e CONTAINER=DOCKER		 -v "/home/ldez/go/src/github.com/traefik/traefik/dist:/go/src/github.com/traefik/traefik/dist" "traefik-dev:v2.6" ./script/make.sh generate binary
