...
More information: https://go.dev/doc/go1.15#commonname
...
as the `x509ignoreCN=0` value for the `GODEBUG` is [deprecated in Go 1.17](https://tip.go.dev/doc/go1.17#crypto/x509),
