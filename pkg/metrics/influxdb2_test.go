...
func TestInfluxDB2(t *testing.T) {
	...
	assert.Equal(t, 1.0, mockInfluxDB2Points[0].FieldList()[0].Value)
	assert.Equal(t, "entrypoint", mockInfluxDB2Points[0].TagList()[0].Key)
	assert.Equal(t, "test", mockInfluxDB2Points[0].TagList()[0].Value)
	assert.Equal(t, "code", mockInfluxDB2Points[0].TagList()[1].Key)
	assert.Equal(t, "200", mockInfluxDB2Points[0].TagList()[1].Value)
	...
	assert.Equal(t, "tls_version", mockInfluxDB2Points[1].TagList()[1].Key)
	assert.Equal(t, "foo", mockInfluxDB2Points[1].TagList()[1].Value)
	assert.Equal(t, "tls_cipher", mockInfluxDB2Points[1].TagList()[2].Key)
	assert.Equal(t, "bar", mockInfluxDB2Points[1].TagList()[2].Value)
	...
	assert.Equal(t, 1.0, mockInfluxDB2Points[0].FieldList()[0].Value)
	assert.Equal(t, "router", mockInfluxDB2Points[0].TagList()[0].Key)
	assert.Equal(t, "demo", mockInfluxDB2Points[0].TagList()[0].Value)
	assert.Equal(t, "service", mockInfluxDB2Points[0].TagList()[1].Key)
	assert.Equal(t, "test", mockInfluxDB2Points[0].TagList()[1].Value)
	assert.Equal(t, "code", mockInfluxDB2Points[0].TagList()[2].Key)
	assert.Equal(t, "404", mockInfluxDB2Points[0].TagList()[2].Value)
	assert.Equal(t, "method", mockInfluxDB2Points[0].TagList()[3].Key)
	assert.Equal(t, "GET", mockInfluxDB2Points[0].TagList()[3].Value)

	assert.Equal(t, routerReqsTotalName, mockInfluxDB2Points[1].FieldList()[0].Key)
	assert.Equal(t, 1.0, mockInfluxDB2Points[1].FieldList()[0].Value)
	assert.Equal(t, "router", mockInfluxDB2Points[1].TagList()[0].Key)
	assert.Equal(t, "demo", mockInfluxDB2Points[1].TagList()[0].Value)
	assert.Equal(t, "service", mockInfluxDB2Points[1].TagList()[1].Key)
	assert.Equal(t, "test", mockInfluxDB2Points[1].TagList()[1].Value)
	assert.Equal(t, "code", mockInfluxDB2Points[1].TagList()[2].Key)
	assert.Equal(t, "200", mockInfluxDB2Points[1].TagList()[2].Value)
	assert.Equal(t, "method", mockInfluxDB2Points[1].TagList()[3].Key)
	assert.Equal(t, "GET", mockInfluxDB2Points[1].TagList()[3].Value)
	...
	assert.Equal(t, "tls_cipher", mockInfluxDB2Points[2].TagList()[3].Key)
	assert.Equal(t, "bar", mockInfluxDB2Points[2].TagList()[3].Value)
	...
	assert.Equal(t, "router", mockInfluxDB2Points[3].TagList()[0].Key)
	assert.Equal(t, "demo", mockInfluxDB2Points[3].TagList()[0].Value)
	assert.Equal(t, "service", mockInfluxDB2Points[3].TagList()[1].Key)
	assert.Equal(t, "test", mockInfluxDB2Points[3].TagList()[1].Value)
	assert.Equal(t, "code", mockInfluxDB2Points[3].TagList()[2].Key)
	assert.Equal(t, "200", mockInfluxDB2Points[3].TagList()[2].Value)
	...
	assert.Equal(t, "test", mockInfluxDB2Points[1].TagList()[0].Value)
	assert.Equal(t, "code", mockInfluxDB2Points[1].TagList()[1].Key)
	assert.Equal(t, "404", mockInfluxDB2Points[1].TagList()[1].Value)
	assert.Equal(t, "method", mockInfluxDB2Points[1].TagList()[2].Key)
	assert.Equal(t, "GET", mockInfluxDB2Points[1].TagList()[2].Value)
	...
	assert.Equal(t, "test", mockInfluxDB2Points[2].TagList()[0].Value)
	assert.Equal(t, "tls_version", mockInfluxDB2Points[2].TagList()[1].Key)
	assert.Equal(t, "foo", mockInfluxDB2Points[2].TagList()[1].Value)
	...
	assert.Equal(t, 10000.0, mockInfluxDB2Points[3].FieldList()[0].Value)
	assert.Equal(t, "service", mockInfluxDB2Points[3].TagList()[0].Key)
	assert.Equal(t, "test", mockInfluxDB2Points[3].TagList()[0].Value)
	assert.Equal(t, "code", mockInfluxDB2Points[3].TagList()[1].Key)
	assert.Equal(t, "200", mockInfluxDB2Points[3].TagList()[1].Value)
