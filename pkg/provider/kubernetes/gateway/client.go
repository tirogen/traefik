...
type Client interface {
	...
	GetHTTPRoutes(namespace string, selector labels.Selector) ([]*v1alpha2.HTTPRoute, error)
	GetTCPRoutes(namespace string, selector labels.Selector) ([]*v1alpha2.TCPRoute, error)
	GetTLSRoutes(namespace string, selector labels.Selector) ([]*v1alpha2.TLSRoute, error)
...
func (c *clientWrapper) GetHTTPRoutes(namespace string, selector labels.Selector) ([]*v1alpha2.HTTPRoute, error) {
	...
	httpRoutes, err := c.factoriesGateway[c.lookupNamespace(namespace)].Gateway().V1alpha2().HTTPRoutes().Lister().HTTPRoutes(namespace).List(selector)
	if err != nil {
		return nil, err
	}
...
func (c *clientWrapper) GetTCPRoutes(namespace string, selector labels.Selector) ([]*v1alpha2.TCPRoute, error) {
	if !c.isWatchedNamespace(namespace) {
	...
	tcpRoutes, err := c.factoriesGateway[c.lookupNamespace(namespace)].Gateway().V1alpha2().TCPRoutes().Lister().TCPRoutes(namespace).List(selector)
	if err != nil {
		return nil, err
	}
...
func (c *clientWrapper) GetTLSRoutes(namespace string, selector labels.Selector) ([]*v1alpha2.TLSRoute, error) {
	if !c.isWatchedNamespace(namespace) {
	...
	tlsRoutes, err := c.factoriesGateway[c.lookupNamespace(namespace)].Gateway().V1alpha2().TLSRoutes().Lister().TLSRoutes(namespace).List(selector)
	if err != nil {
		return nil, err
	}
